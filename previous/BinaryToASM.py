...
class BinaryToASM:
    ...
    * 
    ...
    def determine_instruction_type(self, partial_binary_stream:int) -> str:
        ...
        # assume input is 32 char of 1/0 str
        for i in range(12):
            if partial_binary_stream >> (31 - i) in self.INSTRUCTIONS.values():
                return self.get_instruction_from_opcode(partial_binary_stream >> (31-i))
        ...
        raise KeyError("Error finding matching instruction for " + bin(partial_binary_stream))
    ...
    def get_instruction_from_opcode(self, opcode:int) -> str:
        """
